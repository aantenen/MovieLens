...
```
The next approach used expanded on the individual data point affects and tested the combined affects of the factors on the rating. By combining two of the datapoints, predictions are significantly improved. 
